...
class FlightApi(object):
    ...
    def arcgisearth_flight_post(self, **kwargs):  # noqa: E501
        """Fly-to a target position  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.arcgisearth_flight_post(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param AGEFlight body:
        ...
        if kwargs.get('async_req'):
            return self.arcgisearth_flight_post_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.arcgisearth_flight_post_with_http_info(**kwargs)  # noqa: E501
            return data

    def arcgisearth_flight_post_with_http_info(self, **kwargs):  # noqa: E501
        """Fly-to a target position  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.arcgisearth_flight_post_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method arcgisearth_flight_post" % key
                )
            params[key] = val
        del params['kwargs']
