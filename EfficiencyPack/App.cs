...
namespace EfficiencyPack
{
    internal class App : IExternalApplication
    {
        public Result OnStartup(UIControlledApplication app)
        {
            ...
            ButtonDataClass myButtonData3 = new ButtonDataClass("DuplicateSheet", "Duplicate Sheet", DuplicateViewsCommand.GetMethod(), Properties.Resources.Blue_32, Properties.Resources.Blue_16, "Select Sheet. Run command.");
            ButtonDataClass myButtonData4 = new ButtonDataClass("FloorByDepartment", "Floors by Department", FloorByDepartment.GetMethod(), Properties.Resources.Blue_32, Properties.Resources.Blue_16, "Select rooms. Run command. Get Floors.");
