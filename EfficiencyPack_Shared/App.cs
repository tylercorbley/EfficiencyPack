...
namespace EfficiencyPack
{
    internal class App : IExternalApplication
    {
        public Result OnStartup(UIControlledApplication app)
        {
            ...
            ButtonDataClass BtnFloorByRoom = new ButtonDataClass("FloorByRoom", "Floors by \rRooms", FloorByRoom.GetMethod(), EfficiencyPack_Resources.Properties.Resources.Blue_32, EfficiencyPack_Resources.Properties.Resources.Blue_16, "Select rooms. Run command and follow prompt to select type of floor to populate.");
#if REVIT2022
            ButtonDataClass BtnDuplicateSheet = new ButtonDataClass("DuplicateSheet", "Duplicate \rSheet", DuplicateViewsCommand.GetMethod(), EfficiencyPack_Resources.Properties.Resources.Blue_32, EfficiencyPack_Resources.Properties.Resources.Blue_16, "Select Sheet. Run command.");
#endif
            ButtonDataClass BtnFloorByDepartment = new ButtonDataClass("FloorByDepartment", "Floors by \rDepartment", FloorByDepartment.GetMethod(), EfficiencyPack_Resources.Properties.Resources.Blue_32, EfficiencyPack_Resources.Properties.Resources.Blue_16, "Select rooms. Run command. Get Floors.");
            ButtonDataClass BtnLinesByRoom = new ButtonDataClass("LinesByRoom", "Lines by \rRoom", LinesByRoom.GetMethod(), EfficiencyPack_Resources.Properties.Resources.Blue_32, EfficiencyPack_Resources.Properties.Resources.Blue_16, "Select rooms. Run command. Get Outline.");
            ButtonDataClass BtnRoomPlanGen = new ButtonDataClass("RoomPlanGen", "Plans by \rRoom", RoomPlanGen.GetMethod(), EfficiencyPack_Resources.Properties.Resources.Blue_32, EfficiencyPack_Resources.Properties.Resources.Blue_16, "Select rooms. Run command. Get Plans.");
            ButtonDataClass BtnCenterRoom = new ButtonDataClass("CenterRoom", "Center\rRoom", RoomTagCenteringCommand.GetMethod(), EfficiencyPack_Resources.Properties.Resources.Blue_32, EfficiencyPack_Resources.Properties.Resources.Blue_16, "Select rooms. Center rooms.");
            ButtonDataClass BtnCenterRoomTag = new ButtonDataClass("CenterRoomTag", "Center\rRoom tag", RoomTagCenteringCommandTag.GetMethod(), EfficiencyPack_Resources.Properties.Resources.Blue_32, EfficiencyPack_Resources.Properties.Resources.Blue_16, "Select rooms. Center tags.");
            ButtonDataClass BtnRenameView = new ButtonDataClass("RenameView", "Rename\rView", RenameView.GetMethod(), EfficiencyPack_Resources.Properties.Resources.Blue_32, EfficiencyPack_Resources.Properties.Resources.Blue_16, "Select room. Rename View.");
            ButtonDataClass BtnDoorFireRating = new ButtonDataClass("DoorFireRating", "Door Fire\rRating", DoorFireRating.GetMethod(), EfficiencyPack_Resources.Properties.Resources.Blue_32, EfficiencyPack_Resources.Properties.Resources.Blue_16, "Select doors to set their fire rating.");
            ButtonDataClass BtnDoorCMUGWB = new ButtonDataClass("DoorCMU/GWB", "Door Inset\rOr Wrapped", DoorInsetWrap.GetMethod(), EfficiencyPack_Resources.Properties.Resources.Blue_32, EfficiencyPack_Resources.Properties.Resources.Blue_16, "Select doors to set whether they are inset or wrapped.");
            ...
            ButtonDataClass BtnInteriorElevation = new ButtonDataClass("InteriorElevation", "Make Interior\rElevations", InteriorElevation.GetMethod(), EfficiencyPack_Resources.Properties.Resources.Blue_32, EfficiencyPack_Resources.Properties.Resources.Blue_16, "Select rooms to elevate.");
            ButtonDataClass BtnModifyCrop = new ButtonDataClass("ModifyCropBoundaryCommand", "Raise Crop\rBoundary", ModifyCropBoundaryCommand.GetMethod(), EfficiencyPack_Resources.Properties.Resources.Blue_32, EfficiencyPack_Resources.Properties.Resources.Blue_16, "Raises the crop boundary of selected views");
            ...
            // NOTE:
            // To create a new tool, copy lines 35 and 39 and rename the variables to "BtnDuplicateSheet" and "myButton3". 
