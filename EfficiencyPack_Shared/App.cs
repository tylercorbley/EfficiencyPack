...
namespace EfficiencyPack
{
    ...
    internal class App : IExternalApplication
    {
        public Result OnStartup(UIControlledApplication app)
        {
            ...
            ButtonDataClass BtnDoorStorefrontMark = new ButtonDataClass("DoorStorefrontMark", "Door Storefront\rMark", DoorStorefrontMark.GetMethod(), IconSelector.SelectIcon(dark, "window_32"), IconSelector.SelectIcon(dark, "window_16"), "Select storefront or curtainwall doors. Get mark based on the storefront mark.");
